...
const Suggest: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    localStorage.setItem('bbeoggugi_inquiries', JSON.stringify([newSuggest, ...inquiries]));
      ...
      <section className="mb-32 pt-10 text-center">
        ...
        <div className="relative z-10 pt-20">
          <h1 className="text-4xl md:text-5xl font-serif mb-6 tracking-tight text-[#111111]">
            New Ideas &<br/>Creative Proposals
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
          ...
          <div className="space-y-2 group">
            ...
            >
              ...
              <option value="Artist">Artist / Designer Suggestion</option>
              <option value="Product">Product / Material Proposal</option>
              <option value="Project">Special Project Request</option>
          ...
          <div className="space-y-2 group">
            <label className="text-[9px] uppercase font-bold text-gray-400 tracking-widest ml-1 group-focus-within:text-black transition-colors">Details</label>
            <textarea 
              required
              ...
              placeholder="Please describe your creative suggestion in detail." 
              rows={5}
          ...
          <div className="space-y-4">
             <label className="text-[9px] uppercase font-bold text-gray-400 tracking-widest ml-1 block">Attachments (PDF, PPT, ZIP, Images)</label>
             <div className="relative">
                <input 
                  type="file" 
                  onChange={handleFileChange}
                  className="absolute inset-0 opacity-0 cursor-pointer w-full h-full"
                  accept=".pdf,.jpg,.jpeg,.png,.zip,.ppt,.pptx"
                />
                <div className="w-full border border-dashed border-gray-200 p-10 text-center rounded-sm hover:bg-gray-50 transition-colors">
                   <div className="space-y-2">
                      <span className="eng-text text-[10px] uppercase font-black tracking-widest">
                        {formData.fileName || 'Click to Upload Proposal'}
                      </span>
